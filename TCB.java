/**
 * You do not need to implement TCB.java, use the .class provided in the ThreadOS folder. 
 * @author sacht
 */
public class TCB {
    ...
    public TCB(Thread newThread, int myTid, int parentTid) {
        ...
        for (FileTableEntry entry : ftEnt) {
            entry = null; //init all to null
            //keep 0-2 null, as they are stdin, stdout and stderr
        }
